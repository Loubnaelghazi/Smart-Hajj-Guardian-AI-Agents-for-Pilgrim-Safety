    ...
    <div className="page-stack">
      ...
      <section className="panel">
        <div className="panel-heading">
          <div>
            <span className="panel-kicker">INCIDENT OPERATIONS</span>
            <h2>Active safety incidents</h2>
          </div>
          <span className="critical-chip">{incidents.length} active</span>
        </div>
        ...
        {incidents.length === 0 ? (
          <div className="empty-state">
            ...
            <p>Guardian is monitoring registered pilgrims and groups.</p>
          </div>
        ) : (
